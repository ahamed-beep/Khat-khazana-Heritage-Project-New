...
const NineteenNinety = () => {
  const letters = [
    {
      date: "Saturday, 11 February 1990",
   ...
   <Nax/>
    <div className="font-serif bg-white text-black min-h-screen">
      <div className="text-center py-10">
        <h1 className="text-5xl font-bold text-[#e75b1e]">1990 Letters</h1>
      </div>
