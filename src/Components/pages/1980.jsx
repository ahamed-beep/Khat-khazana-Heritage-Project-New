...
const NineteenEighty = () => {
  const letters = [
    {
      date: "Saturday, 11 February 1980",
      ...
      more: "His legacy blends wit and science fiction, encouraging readers to see the absurd in the ordinary."
    },
    {
      date: "Thursday, 12 January 1980",
      title: "Into Eternity",
      ...
      more: "It remains a haunting tribute to maternal courage and the power of final words."
    },
    {
      date: "Tuesday, 06 December 1980",
      ...
      more: "His resilience became a symbol of bravery and vulnerability in difficult times."
    },
    {
      date: "Tuesday, 05 October 1980",
      ...
      more: "The letter blends humor and subtle critique, offering a glimpse into his early creativity."
    },
    {
      date: "Sunday, 23 September 1980",
      ...
      more: "His message captures the timeless struggle between silence and expression in a turbulent era."
    },
    {
      date: "Monday, 14 August 1980",
      ...
      more: "The warmth in his words provides light in the darkness of war."
    },
    {
      date: "Wednesday, 03 July 1980",
      ...
      more: "Her loving words serve as both comfort and strength for generations."
    },
    {
      date: "Friday, 16 March 1980",
      ...
      more: "Their friendship, preserved in ink, endures across oceans and years."
    }
  ];
  ...
  return (
    ...
    <div className="font-serif bg-white text-black min-h-screen">
      <div className="text-center py-10">
        <h1 className="text-5xl font-bold text-[#e75b1e]">1980 Letters</h1>
      </div>
