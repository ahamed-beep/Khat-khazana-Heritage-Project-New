...
const NineteenSeventy = () => {
  const letters = [
    {
      date: "Saturday, 11 February 1970",
  ...
  return (
    <div className="font-serif bg-white text-black min-h-screen">
      <div className="text-center py-10">
        <h1 className="text-5xl font-bold text-[#e75b1e]">1970 Letters</h1>
      </div>
